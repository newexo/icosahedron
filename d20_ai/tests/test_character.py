...
from d20_ai.d20_rules.character_class import CharacterClass, Character
...
class TestCharacter(unittest.TestCase):
    def test_compute_hit_points(self):
        ...
        character = Character(level=1, character_class=char_class, constitution_modifier=2)
    ...
    def test_compute_base_attack_bonus(self):
        char_class = CharacterClass(hit_dice=10, base_attack_bonus=1, bab_progression=0.75, skill_points=2)
        character = Character(level=3, character_class=char_class, constitution_modifier=2)
    ...
    def test_compute_skill_points(self):
        char_class = CharacterClass(hit_dice=10, base_attack_bonus=1, bab_progression=0.75, skill_points=2)
        character = Character(level=5, character_class=char_class, constitution_modifier=2)
