...
class TestD20CharacterSheet(unittest.TestCase):
    def test_init(self):
        ...
        self.assertEqual(
            alice.feats[0]["description"], "+5 initiative and cannot be surprised"
        )
        self.assertEqual(alice.feats[1]["name"], "Magic Initiate")
        self.assertEqual(
            alice.feats[1]["description"],
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(
            alice_dict["feats"][0],
            {"name": "Alert", "description": "+5 initiative and cannot be surprised"},
        )
        self.assertEqual(
            alice_dict["feats"][1],
            {
